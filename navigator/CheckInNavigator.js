...
import CheckInPage3formated from '../screens/check-in/CheckInPage3formated';
...
const CheckInNavigator = () => {
  return (
    <Stack.Navigator initialRouteName="CheckInPage1">
      ...
      <Stack.Screen name="CheckInPage3formated" component={CheckInPage3formated} options={{ headerShown: false }} />
      ...
      <Stack.Screen name="OtherPageInputFormated" component={OtherPageInputFormated} options={{ headerShown: false }}/> 
